...
=== "Claude Code"
    ...
    O extra instala o Claude Agent SDK, que traz o Claude Code CLI. A autenticação é a do próprio Claude Code (login no CLI ou `ANTHROPIC_API_KEY`). Ver [Provedores](../guides/providers.md#claude-code).
