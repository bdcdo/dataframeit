...
def test_retomada_de_checkpoint_textual_nao_reprocessa(tmp_path, extensao):
    ...
    def responde(text, *args, **kwargs):
        # Uma linha com observação vazia e outra preenchida: CSV/XLSX gravam ""
        # como vazio, e a coluna com valor mostra que o vazio era "".
        observacao = '' if text == 'x' else 'nota'
